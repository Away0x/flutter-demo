    ...
    return [
      Expanded(
        child: TabIcon(
            ...
            removeAllSelect: () {
              _setRemoveAllSelection(widget.tabIconsList[0]);
      ...
      Expanded(
        child: TabIcon(
            ...
            removeAllSelect: () {
              _setRemoveAllSelection(widget.tabIconsList[1]);
      ...
      Expanded(
        child: TabIcon(
            ...
            removeAllSelect: () {
              _setRemoveAllSelection(widget.tabIconsList[2]);
      ...
      Expanded(
        child: TabIcon(
            ...
            removeAllSelect: () {
              _setRemoveAllSelection(widget.tabIconsList[3]);
