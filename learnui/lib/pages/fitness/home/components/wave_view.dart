            ...
            ClipPath(
              child: Container(
                decoration: BoxDecoration(
                  color: FitnessTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      FitnessTheme.nearlyDarkBlue.withOpacity(0.2),
                      FitnessTheme.nearlyDarkBlue.withOpacity(0.5)
                    ],
            ...
            ClipPath(
              child: Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      FitnessTheme.nearlyDarkBlue.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: FitnessTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: FitnessTheme.white.withOpacity(
