...
class _CustomCalenderState extends State<CustomCalender> {
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Row(
            children: _buildDaysName(),
          ),
        ),
        Padding(
          padding: const EdgeInsets.only(right: 8, left: 8),
          child: Column(
            children: _buildDaysNo(),
          ),
        ),
      ],
    );
  ...
  Widget _buildArrowButton({bool isLeft = true}) {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: HotelBookingTheme.buildLightTheme().dividerColor,
          ),
        ),
        child: Material(
            ...
            onTap: () {
              setState(() {
                currentMonthDate = DateTime(currentMonthDate.year,
                    currentMonthDate.month + (isLeft ? 0 : 2), 0);
                setListOfDate(currentMonthDate);
              });
            },
            child: Icon(
                          ...
                          decoration: BoxDecoration(
                            color: () {
                              ...
                              if (getIsItStartAndEndDate(date) ||
                                  getIsInRange(date)) {
                                return HotelBookingTheme.buildLightTheme()
                                    .primaryColor
                                    .withOpacity(0.4);
                              }
